...
class VideoRedactor(QMainWindow):
    class Explorer(QDialog):
        ...
        def resoult(self):
            ...
            if self.selected_video_file is not None:
                print(self.selected_video_file)
    ...
    def resizeEvent(self, event):
        ...
        self.close_app_button.setGeometry(frame_x, 0, int(frame_width//7), int(frame_height//7))
        ...
        self.close_settings_menu_btn.setMinimumWidth(int(frame_width // 4))
        self.close_settings_menu_btn.setMaximumWidth(int(frame_width // 4))
...
# Функция вызова окна входа/регистрации
    def profile_function(self):
        # Вызов окна
        self.thread_profile = threading.Thread(target=self.run_profile)
        self.thread_profile.start()
    ...
    def run_profile(self):
        try:
            ...
            profile_seletc_window.Profile(self.dubl_prof, False)
